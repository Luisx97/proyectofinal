        ...
        <div class="container-fluid ">
            <div class="row">
                ...
                <form name="form-work" action="scripts/encuesta_guardar.php" method="POST">
                        ...
                        <input class="form-control" name="encuesta_titulo" id="encuesta_titulo" type="text"
                            placeholder="Nombre de la encuesta" aria-label="default input example">
                        <br>
                        ...
                        <input class="form-control" type="text" name="encuesta_descripcion" id="encuesta_descripcion"
                            placeholder="Ingresa una breve descripción de la encuesta"
